...
| `REDIS_PASS` | - | Redis 认证密码 |
| `DISALLOW_USER_LOGIN_REMOTELY` | `0` | 禁止远程用户登录（1=启用，0=禁用） |
| `REDIS_PORT` | `6379` | 自定义 Redis 服务端监听端口 |
...
- `snowdreamtech/redis:8.8.0-alpine`
- `snowdreamtech/redis:8.0.2-debian`
- `snowdreamtech/redis:8.0.4-rocky`
